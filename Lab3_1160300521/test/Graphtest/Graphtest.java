...
public class Graphtest {
	...
	//	vertex in graph
	@Test
	public void testaddvertexcotain() {
		Graph<Vertex, Edge> graph = Graph.empty();
		graph.addVertex(v1);
        assertTrue("expected True, added vertex to the graph", graph.addVertex(v1));
        assertTrue("expected graph size 1", graph.vertices().size() == 1);
	...
	//	source, target = in graph
	@Test
    public void testaddEdgeweightzero() {
		Graph<Vertex, Edge> graph = Graph.empty();
		graph.addVertex(v1);
		graph.addVertex(v2);
		graph.addEdge(e1);
    ...
    //	edge size = 0
	@Test
    public void testremoveEdgenotin() {
		Graph<Vertex, Edge> graph = Graph.empty();
    ...
    public void testsourcenotin() {
        ...
        assertEquals("expected the vertex to contain zero sources", sources, graph.sources(v1));
    }
    ...
    //	vertex = not in graph
	@Test
    public void testgetdistancenotin() {
		Graph<Vertex, Edge> graph = Graph.empty();
        graph.addVertex(v1);
