...
public class MovieGraphApp {
  ...
  private static void justedge(String str, MovieGraph graph)
    ...
    if (info[1].equals("MovieDirectorRelation")) {
      MovieDirectorRelation r = (MovieDirectorRelation) new MovieDirectorRelationFactory()
          .createEdge(info[0], vers, weight);
      graph.addEdge(r);
    } else if (info[1].equals("MovieActorRelation")) {
      MovieActorRelation r =
          (MovieActorRelation) new MovieActorRelationFactory().createEdge(info[0], vers, weight);
      graph.addEdge(r);
    } else {
  ...
  public static void main(String[] args)
    ...
    int n = it.nextInt();
    MovieGraph graph = (MovieGraph) new MovieGraphFactory().createGraph("src/source/file2.txt", n);
