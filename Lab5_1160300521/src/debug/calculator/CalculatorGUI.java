...
public class CalculatorGUI extends JFrame {
  ...
  public CalculatorGUI() {
    ...
    for (int i = 0; i < btnNum.length; i++) {
      ...
      btnNum[i].addActionListener((ActionListener) new DigitActionListener());
    }
  ...
  public void performOperation() {
    if (!buffer.equals(".")) {
      // Handles edge case of first input after default state where buffer is empty and result is
      // zero
