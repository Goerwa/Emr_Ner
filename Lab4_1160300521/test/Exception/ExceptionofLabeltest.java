...
public class ExceptionofLabeltest {
    ...
    @Test
    public void testlabel1() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  是否出现重复 = 是  
    @Test
    public void testlabel2() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
	GraphPoet g1 = new GraphPoet();
	g1.addVertex(w1);
	g1.addVertex(w2);
	g1.addVertex(w3);
    ...
    //  是否出现重复 = 是  
    @Test
    public void testlabel3() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  是否出现重复 = 是  
    @Test
    public void testlabel4() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
	SocialNetwork g2 = new SocialNetwork();
	g2.addVertex(p1);
	g2.addVertex(p2);
	g2.addVertex(p3);
    ...
    //  是否出现重复 = 是 
    @Test
    public void testlabel5() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  是否出现多重边 = 是 
    @Test
    public void testlabel6() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
	NetworkTopology g3 = new NetworkTopology();
	g3.addVertex(c1);
	g3.addVertex(r1);
	g3.addVertex(c2);
    ...
    //  是否出现重复 = 是  
    @Test
    public void testlabel7() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  是否出现重复 = 是 
    @Test
    public void testlabel8() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
	MovieGraph g4 = new MovieGraph();
	g4.addVertex(m1);
	g4.addVertex(a1);
	g4.addVertex(a2);
