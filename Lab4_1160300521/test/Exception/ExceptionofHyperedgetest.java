...
public class ExceptionofHyperedgetest {
    ...
    public void testhyper1() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  是否可出现超边 = 否 
    @Test(expected = ExceptionofUnproperEdge.class)
    public void testhyperedge1() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  是否可出现超边 = 否  
    @Test(expected = ExceptionofUnproperEdge.class)
    public void testhyperedge2() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  是否可出现超边 = 否   
    @Test(expected = ExceptionofUnproperEdge.class)
    public void testhyperedge3() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
