...
public class ExceptionofWeighttest {
    ...
    public void testweight1() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    public void testweight2() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  带权边的权值是否符合要求 = 否
    @Test(expected = ExceptionofInput.class)
    public void testweight3() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
	SocialNetwork g2 = new SocialNetwork();
        SocialNetworkFactory f2 = new SocialNetworkFactory();
    ...
    //  带权边的权值是否符合要求 = 否 
    @Test(expected = ExceptionofUnproperEdge.class)
    public void testweight4() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
    ...
    //  带权边的权值是否符合要求 = 否 
    @Test(expected = ExceptionofUnproperEdge.class)
    public void testweight5() throws ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection, ExceptionofUndirection {
