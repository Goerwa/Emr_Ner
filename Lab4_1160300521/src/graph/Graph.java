...
public interface Graph<L,E> {
     ...
     */
    public boolean addVertex(L v) throws ExceptionofInput;  
    /**
     ...
     */
    public boolean addEdge(E edge) throws ExceptionofInput, ExceptionofUnproperEdge;
    /**
     ...
     * @throws ExceptionofUnproperEdge 
     */
    public boolean removeEdge(E edge) throws ExceptionofInput, ExceptionofUnproperEdge;
    /**
    ...
    public L findvertexbylabel(String str);
}
