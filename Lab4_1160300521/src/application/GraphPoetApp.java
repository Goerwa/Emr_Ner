...
public class GraphPoetApp {
	...
	private static void justedge(String str,Graph graph) throws ExceptionofInput, ExceptionofUnproperEdge  {
		System.out.println("your input string is:\t"+str);
		...
		WordNeighborhood r = (WordNeighborhood) new WordNeighborhoodFactory().createEdge(info[0], vers, weight);
		graph.addEdge(r);
	}
	...
	private static void justremovee(String str,Graph graph) throws ExceptionofInput, ExceptionofUnproperEdge{
		System.out.println("your input string is:\t"+str);
	...
	public static void main(String[] args) throws IOException, ExceptionofInput, ExceptionofUnproperEdge, ExceptionofDirection{
